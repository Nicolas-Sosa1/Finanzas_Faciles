...
public class ActividadesViewModel : BaseViewModel
{
    ...
    {
        Id = a.Id, Nombre = a.Nombre, CostoDirecto = a.CostoDirecto,
        MargenGanancia = a.MargenGanancia, ModoPrecio = a.ModoPrecio,
        PrecioVentaFijo = a.PrecioVentaFijo, Estado = a.Estado
    };
